...
def preprocess(sentence):
    ...
    atoz = re.compile('[a-zA-Z]')
    
    new_words =  [entry.lower() for entry in words if atoz.match(entry)]
...
''' Function copied from https://github.com/PLCoster/cs50ai-week6-parser/blob/master/parser.py'''
